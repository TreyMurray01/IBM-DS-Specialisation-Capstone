...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        fig = px.pie(spacex_df[spacex_df['Launch Site'] == selected_site], names='Launch Site', title=f'Success vs. Failed Counts for {selected_site}')
    return fig
...
def update_scatter_chart(selected_site, payload_range):
    ...
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Launch Site', title='Correlation between Payload and Launch Success')
    return fig
